...
url = 'https://www.googleapis.com/customsearch/v1?key='+access_token+'&cx='+cse_id+'&tbm=pts&q='+ urllib.quote(search_text) + '&tbs=,cdr:1,cd_min:Jan+1_2+2003,cd_max:Dec+31_2+2004,ptsdt:a'
print url
